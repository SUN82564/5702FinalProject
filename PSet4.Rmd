...
Yue Wang will be the person whoe will merge pull requests. In  order to avoid conflicts, we will communicate with each other once we have updated something through email to make sure they use the most updated file when folk it.\
